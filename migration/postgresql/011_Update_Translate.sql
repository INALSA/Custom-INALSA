...
-- 08/05/2013 09:24:20 AM VET
-- LVE Retention
UPDATE AD_Tab_Trl SET Name='Grupo de Retenciones',Description='Grupo de Retenciones',Help='Grupo de Retenciones',Updated=TO_TIMESTAMP('2013-05-08 09:24:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=3000203 AND AD_Language='es_VE'
;

-- 08/05/2013 09:28:19 AM VET
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET IsUpdateable='N',Updated=TO_TIMESTAMP('2013-05-08 09:28:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000322
;

-- 08/05/2013 09:29:40 AM VET
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET SeqNo=50,IsDisplayed='Y' WHERE AD_Field_ID=3000261
;
...
-- 08/05/2013 09:44:34 AM VET
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET SeqNo=330,IsDisplayed='Y' WHERE AD_Field_ID=3000059
;

-- 08/05/2013 09:44:34 AM VET
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET SeqNo=340,IsDisplayed='Y' WHERE AD_Field_ID=3000226