...
public class Doc_Cash extends Doc
{
	...
	private DocTax[] loadTaxes()
	{
		...
		String sql = "SELECT it.C_Tax_ID, t.Name, t.Rate, it.TaxBaseAmt, it.TaxAmt, t.IsSalesTax "
			+ "FROM C_Tax t Inner Join C_CashTax it On t.C_Tax_ID=it.C_Tax_ID " 
			+ "				Inner Join C_Cash ch on it.C_Cash_ID=ch.C_Cash_ID "
			+ "WHERE it.C_Cash_ID=? And ch.DocStatus In ('DR','CO','CL')";
		try
		{
