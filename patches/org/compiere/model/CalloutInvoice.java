...
public class CalloutInvoice extends CalloutEngine
{
	...
	/**
	 * Change By Jorge Colmenarez 2014-07-18 
	 * Add Value of IsManual Column into Invoice Header
	 *	Invoice Header - DocType.
	 *		- PaymentRule
	 *		- temporary Document
	 *		- IsManual Checked Only Invoice of Sold
	 *  Context:
	 *  	- DocSubTypeSO
	 *		- HasCharges
	...
	public String docType (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		...
		String sql = "SELECT d.HasCharges,'N',d.IsDocNoControlled," // 1..3
			...
			+ "d.IsManual, d.IsSOTrx " //9..10 Add by Jorge Colmenarez 2014-07-18
		...
		try
		{
			...
			if (rs.next())
			{
				...
				// Checked IsManual if value is 'Y' And IsSOTrx value is 'Y'
				if(rs.getString(9).equals("Y") && rs.getString(10).equals("Y"))
				{
					mTab.setValue("IsManual",rs.getString(9));
				}
				else{
					mTab.setValue("IsManual","N");
				}
	...
	/** End Change By Jorge Colmenarez 2014-07-18 **/
