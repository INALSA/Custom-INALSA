...
public class X_C_CashTax extends PO implements I_C_CashTax, I_Persistent 
{
    ...
    public X_C_CashTax (Properties ctx, int C_CashTax_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_C_CashTax (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_CashTax[")
