	...
	protected String doIt() throws java.lang.Exception
	{
	   ...
	   //	ORDER BY ValidFrom DESC
		...
		sql = new StringBuffer ("UPDATE I_GLJournal i "
			...
			//	Modified By Jorge Colmenarez 2015-02-26
			//	Fixed Bad Comparation with Value of Organization
		...
		*/
		...
		try
		{
			...
			while (rs.next())
			{
				...
				//
				//	Added By Jorge Colmenarez 2015-04-18
				//	Set Org from Import OrgTrx or Org
				int Org;
				if(imp.getAD_OrgTrx_ID()!=0)
					Org = imp.getAD_OrgTrx_ID();
				else
					Org = imp.getAD_Org_ID();
				//	Set Org into line
				line.setAD_Org_ID(Org);
				//	End Jorge Colmenarez
				...
				{
					//	Added By Jorge Colmenarez 2015-04-18 
					//	Set Org at parameter for method MAccount.get
					MAccount acct = MAccount.get(getCtx(), imp.getAD_Client_ID(), Org, // imp.getAD_Org_ID(),
					//	End Jorge Colmenarez 
