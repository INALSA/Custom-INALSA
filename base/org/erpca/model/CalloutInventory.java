...
public class CalloutInventory extends CalloutEngine
{
	...
	/**
	 * Cambia el signo de la cantidad de uso interno
	 * @author Yamel Senih 31/03/2011, 15:10:48
	 * @param ctx
	 * @param WindowNo
	 * @param mTab
	 * @param mField
	 ...
	 * @return String
	 */
	public String qtyInternalUse(Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value) {
		if (isCalloutActive() || value == null)
			return "";
		
		BigDecimal qty = new BigDecimal(String.valueOf(value));		
		mTab.setValue("QtyInternalUse", qty.negate());
		//
		return "";
	} //  qty
	
	/**
	 * Copia el valor de la cantidad contada en el campo
	 * XXQtyInternalUse
	 * @author Yamel Senih 15/04/2011, 09:09:25
	 * @param ctx
	 * @param WindowNo
	 * @param mTab
	 * @param mField
	 ...
	 * @return String
	 */
	public String qtyCount(Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value) {
		if (isCalloutActive() || value == null)
			return "";
		
		BigDecimal qty = new BigDecimal(String.valueOf(value));
		mTab.setValue("MaskQtyInternalUse", qty);
